...
class FontsControllerTest < ActionController::TestCase
  ...
  test "should create font" do
    assert_difference('Font.count') do
      post :create, font: { iap_price: @font.iap_price, image: @font.image, name: @font.name, product_code: @font.product_code, product_identifier: @font.product_identifier }
    end
  ...
  test "should update font" do
    put :update, id: @font, font: { iap_price: @font.iap_price, image: @font.image, name: @font.name, product_code: @font.product_code, product_identifier: @font.product_identifier }
    assert_redirected_to font_path(assigns(:font))
  end
